...
R package **piamenv**, version **0.2.0**
...
Führlich P (2022). _piamenv: Package environment support for PIAM_. R package version 0.2.0, <https://github.com/pik-piam/piamenv>.
