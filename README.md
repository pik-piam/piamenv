...
R package **piamenv**, version **0.6.0**
...
Sauer P, Rüter T (2024). _piamenv: Package environment support for PIAM_. R package version 0.6.0, <https://github.com/pik-piam/piamenv>.
