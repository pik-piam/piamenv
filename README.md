...
R package **piamenv**, version **0.3.5**
...
Führlich P (2023). _piamenv: Package environment support for PIAM_. R package version 0.3.5, <https://github.com/pik-piam/piamenv>.
