...
R package **piamenv**, version **0.3.4**
...
Führlich P (2022). _piamenv: Package environment support for PIAM_. R package version 0.3.4, <https://github.com/pik-piam/piamenv>.
